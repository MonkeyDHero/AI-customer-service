from langchain.agents.middleware import wrap_tool_call,before_model,dynamic_prompt,before_agent
...
def log_before_agent(state:AgentState,runtime:Runtime)->None:
    logger.info(f"[log_before_agent]agent启动，并附带{len(state['messages'])}消息")